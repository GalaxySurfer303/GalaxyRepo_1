...
public class SeleniumTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.setProperty("webdriver.chrome.driver", "/Users/peterklejment/IdeaProjects/untitled1/src/main/resources/drivers/chromedriver");
        //Set the absolute path to the ChromeDriver executable
